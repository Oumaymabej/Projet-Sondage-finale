fixedRow(
  column(12,
         ...
         h2("Applications pour l'Analyse de Bases de Données de Sondage"),
         HTML("<div style='height: 25px;'>"),
         HTML("</div>"),
         h3("À Propos"),
         h4("La conception et la réalisation de tableaux de bord dynamiques jouent un rôle crucial dans le prétraitement et l'analyse exploratoire des bases de données de Sondage.
            Cette phase est essentielle pour comprendre les relations entre les variables et découvrir de nouvelles connaissances sur les processus de Sondage.
           "),
         ...
         tags$ol(
           tags$li(h4("Téléchargez la base de données dans l'onglet \"Téléchargement\" et cliquez sur Soumettre.")), 
